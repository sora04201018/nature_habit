...
ActiveRecord::Schema[7.2].define(version: 2026_01_06_040319) do
  ...
  create_table "habit_categories", force: :cascade do |t|
    ...
    t.index ["habit_id", "category_id"], name: "index_habit_categories_on_habit_id_and_category_id", unique: true
  ...
  create_table "habit_checks", force: :cascade do |t|
    ...
    t.index ["user_id", "habit_id", "checked_on"], name: "index_habit_checks_on_user_habit_date", unique: true
    t.index ["user_id"], name: "index_habit_checks_on_user_id"
  end
